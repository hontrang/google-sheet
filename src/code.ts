...
// Giả định về các module và kiểu
declare const SheetUtility: any;
declare const Cheerio: any;
declare const SheetHttp: any;
declare const ChartUtil: any;

function getDataHose(): void {
  const DANH_SACH_MA: string[] = SheetUtility.layDuLieuTrongCot(SheetUtility.SHEET_DU_LIEU, "A");
...
function layTinTucSheetBangThongTin(): void {
  ...
  SheetUtility.layDuLieuTrongCot(SheetUtility.SHEET_CAU_HINH, "E").forEach((tenMa: string) => {
  ...
  SheetUtility.ghiDuLieuVaoDayTheoTen(mangDuLieuChinh, SheetUtility.SHEET_BANG_THONG_TIN, 35, "A");
}

function layThongTinChiTietMa(): void {
  SheetUtility.ghiDuLieuVaoO("...", SheetUtility.SHEET_CHI_TIET_MA, "J2");
  const tenMa: string = SheetUtility.layDuLieuTrongO(SheetUtility.SHEET_CHI_TIET_MA, "F1");
...
function layGiaVaKhoiLuongTheoMaChungKhoan(tenMa: string): void {
  const fromDate: string = SheetUtility.layDuLieuTrongO(SheetUtility.SHEET_CHI_TIET_MA, "F2");
  const toDate: string = SheetUtility.layDuLieuTrongO(SheetUtility.SHEET_CHI_TIET_MA, "H2");
  ...
  SheetUtility.ghiDuLieuVaoDayTheoTen(mangDuLieuChinh, SheetUtility.SHEET_DU_LIEU, 2, "P");
}
...
function layTinTucSheetChiTietMa(tenMa: string): void {
  ...
  SheetUtility.ghiDuLieuVaoDayTheoTen(mangDuLieuChinh, SheetUtility.SHEET_DU_LIEU, 2, "AH");
}
...
function layBaoCaoPhanTich(tenMa: string): void {
  ...
  SheetUtility.ghiDuLieuVaoDayTheoTen(mangDuLieuChinh, SheetUtility.SHEET_DU_LIEU, 2, "AL");
}
...
function layThongTinCoDong(tenMa: string): void {
  ...
  SheetUtility.ghiDuLieuVaoDayTheoTen(mangDuLieuChinh, SheetUtility.SHEET_DU_LIEU, 2, "AC");
}
...
/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 532: /***/ function (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) {
      let global = this;
      function load() {}
      (() => {
            ...
            getCodePoint = // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
              String.prototype.codePointAt != null
                ...
                : // http://mathiasbynens.be/notes/javascript-encoding#surrogate-formulae
                  (c, index2) =>
                    (c.charCodeAt(index2) & 64512) === 55296 ? (c.charCodeAt(index2) - 55296) * 1024 + c.charCodeAt(index2 + 1) - 56320 + 65536 : c.charCodeAt(index2);
        ...
        var init_esm4 = __esm({
          'node_modules/dom-serializer/lib/esm/index.js'() {
            ...
            init_esm3();
            init_foreignNames();
            unencodedElements = /* @__PURE__ */ new Set(['style', 'script', 'xmp', 'iframe', 'noembed', 'noframes', 'plaintext', 'noscript']);
            ...
            esm_default = render;
            foreignModeIntegrationPoints = /* @__PURE__ */ new Set(['mi', 'mo', 'mn', 'ms', 'mtext', 'annotation-xml', 'foreignObject', 'desc', 'title']);
          ...
          if (typeof name === 'object' || value !== void 0) {
            if (typeof value === 'function') {
              ...
              return domEach(this, (el, i) => {
                if (isTag2(el)) setAttr(el, name, value.call(el, i, el.attribs[name]));
              });
            }
              ...
              case 'src': {
                ...
                if (
                  ...
                  ((name === 'href' && (el.tagName === 'a' || el.tagName === 'link')) ||
                    (name === 'src' && (el.tagName === 'img' || el.tagName === 'iframe' || el.tagName === 'audio' || el.tagName === 'video' || el.tagName === 'source'))) &&
                  prop2 !== void 0 &&
                ...
                if (action !== 'exists') {
                  if (isQuote(selector.charCodeAt(selectorIndex))) {
                    ...
                    while (
                      ...
                      ((!isWhitespace(selector.charCodeAt(selectorIndex)) && selector.charCodeAt(selectorIndex) !== 93) || isEscaped(selectorIndex))
                    ) {
                      selectorIndex += 1;
                    }
        ...
        var init_parse = __esm({
          'node_modules/css-what/lib/es/parse.js'() {
            ...
            unpackPseudos = /* @__PURE__ */ new Set(['has', 'not', 'matches', 'is', 'where', 'host', 'host-context']);
        ...
        function compileRules(rules, options, context) {
          ...
          return rules.reduce(
            (previous, rule) =>
              previous === import_boolbase5.default.falseFunc ? import_boolbase5.default.falseFunc : compileGeneralSelector(previous, rule, options, context, compileToken),
            (_a2 = options.rootFunc) !== null && _a2 !== void 0 ? _a2 : import_boolbase5.default.trueFunc
          );
        }
        ...
        function convertOptionFormats(options) {
          ...
          (_b = opts.equals) !== null && _b !== void 0
            ? _b
            : (opts.equals = (_d = (_c = opts.adapter) === null || _c === void 0 ? void 0 : _c.equals) !== null && _d !== void 0 ? _d : defaultEquals);
          return opts;
        }
        ...
        var init_esm7 = __esm({
          'node_modules/css-select/lib/esm/index.js'() {
            ...
            selectAll = getSelectorFunc((query, elems, options) =>
              query === import_boolbase6.default.falseFunc || !elems || elems.length === 0 ? [] : options.adapter.findAll(query, elems)
            );
            selectOne = getSelectorFunc((query, elems, options) =>
              query === import_boolbase6.default.falseFunc || !elems || elems.length === 0 ? null : options.adapter.findOne(query, elems)
            );
          }
        });
        ...
        var init_positionals = __esm({
          'node_modules/cheerio-select/lib/esm/positionals.js'() {
            filterNames = /* @__PURE__ */ new Set(['first', 'last', 'eq', 'gt', 'nth', 'lt', 'even', 'odd']);
          }
        });
          ...
          const innerMatcher = _getMatcher((nextElem2, elems) => {
            ...
            domEach(elems, (elem) => {
              for (let next2; (next2 = nextElem2(elem)); elem = next2) {
                if (matches === null || matches === void 0 ? void 0 : matches(next2, matched.length)) break;
                matched.push(next2);
              }
            });
            return matched;
        ...
        var init_unicode = __esm({
          'node_modules/parse5/dist/common/unicode.js'() {
            UNDEFINED_CODE_POINTS = /* @__PURE__ */ new Set([
              65534, 65535, 131070, 131071, 196606, 196607, 262142, 262143, 327678, 327679, 393214, 393215, 458750, 458751, 524286, 524287, 589822, 589823, 655358, 655359, 720894,
            ...
            Preprocessor = class {
              ...
              advance() {
                ...
                const isCommonValidRange =
                  this.handler.onParseError === null || (cp > 31 && cp < 127) || cp === CODE_POINTS.LINE_FEED || cp === CODE_POINTS.CARRIAGE_RETURN || (cp > 159 && cp < 64976);
                      ...
                      result =
                        valueLength === 0
                          ...
                          : valueLength === 1
                            ...
                            : [decode_data_html_default[++i], decode_data_html_default[++i]];
                      excess = 0;
        ...
        var init_open_element_stack = __esm({
          'node_modules/parse5/dist/parser/open-element-stack.js'() {
            init_html();
            IMPLICIT_END_TAG_REQUIRED = /* @__PURE__ */ new Set([
              TAG_ID.DD,
              TAG_ID.DT,
              TAG_ID.LI,
              TAG_ID.OPTGROUP,
        ...
        var init_doctype = __esm({
          'node_modules/parse5/dist/common/doctype.js'() {
            ...
            QUIRKS_MODE_PUBLIC_IDS = /* @__PURE__ */ new Set(['-//w3o//dtd w3 html strict 3.0//en//', '-/w3c/dtd html 4.0 transitional/en', 'html']);
        ...
        function isIntegrationPoint(tn, ns, attrs, foreignNS) {
          return (
            ((!foreignNS || foreignNS === NS.HTML) && isHtmlIntegrationPoint(tn, ns, attrs)) || ((!foreignNS || foreignNS === NS.MATHML) && isMathMLTextIntegrationPoint(tn, ns))
          );
        }
            ...
            Tokenizer2 = class {
              ...
              startEntity() {
                ...
                this.entityDecoder.startEntity(
                  this.xmlMode ? DecodingMode.Strict : this.baseState === State2.Text || this.baseState === State2.InSpecialTag ? DecodingMode.Legacy : DecodingMode.Attribute
                );
              }
              stateInEntity() {
        ...
        var init_Parser = __esm({
          'node_modules/htmlparser2/lib/esm/Parser.js'() {
            init_Tokenizer();
            init_decode();
            formTags = /* @__PURE__ */ new Set(['input', 'option', 'optgroup', 'select', 'button', 'datalist', 'textarea']);
            ...
            htmlIntegrationElements = /* @__PURE__ */ new Set(['mi', 'mo', 'mn', 'ms', 'mtext', 'annotation-xml', 'foreignobject', 'desc', 'title']);
            reNameEnd = /\s|\//;
            Parser2 = class {
              ...
              onattribend(quote, endIndex) {
                ...
                (_b = (_a2 = this.cbs).onattribute) === null || _b === void 0
                  ...
                  : _b.call(
                      ...
                      this.attribname,
                      this.attribvalue,
                      quote === QuoteType.Double ? '"' : quote === QuoteType.Single ? "'" : quote === QuoteType.NoValue ? void 0 : null
                    );
        ...
        var init_load_parse = __esm({
          'node_modules/cheerio/dist/browser/load-parse.js'() {
            ...
            init_esm4();
            init_esm9();
            parse5 = getParse((content, options, isDocument2, context) =>
              options._useHtmlParser2 ? parseDocument(content, options) : parseWithParse5(content, options, isDocument2, context)
            );
        ...
        var require_src = __commonJS({
          'src/index.js'(exports, module) {
            global.load = (init_browser(), __toCommonJS(browser_exports)).load;
  ...
  /******/
  /************************************************************************/
  let Cheerio = __webpack_require__(532);
  /**
   * Return write arguments.
   */
  __webpack_require__.g.Cheerio = Cheerio;
  /******/
})();
